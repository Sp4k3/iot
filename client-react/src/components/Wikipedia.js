                    ...
                    <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                        <form className="space-y-6" action="#" method="POST" onSubmit={this.handleSubmit}>
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <input id="server" name="server" value={this.state.searchValue} onChange={this.handleChange} type="text" required placeholder="terms" className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                                </div>
                            </div>
